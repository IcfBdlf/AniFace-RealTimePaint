...
用户反馈全程引导过于贴合草稿，希望优先试验 XL 的细节生成，授权选择合理控制比例。单种子“陈”线稿对照 1.0、0.35、0.6 后，将默认 HQ_CONTROLNET_ENDING_STEP 设为 0.6；0.35 服装/躯干改动较大，0.6 在保留轮廓与补充细节之间更折中。其他生成参数不变，精细约 15.3 秒，20 项针对性测试通过。重新启动应用且不勾选“尽量跟随线稿”才使用新默认；角色预设可覆盖它。详细结果见 SDXL_VALIDATION.md，不宣称粗稿或相对 SD1.5 画质已验收。
